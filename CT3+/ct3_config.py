...
def add_ct3_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--kb_paths", type=str, nargs='+', default=None, help="Paths to the knowledge base.")
    ...
    parser.add_argument("--learning_rate", type=float, default=1e-6, help="Learning rate for test-time training.")
    parser.add_argument("--batch_size", type=int, default=1, help="Batch size for test-time training.")
    parser.add_argument("--lora_rank", type=int, default=64, help="LoRA rank for test-time training.")
