...
parser.add_argument('--nasspace', default='nds_amoeba', type=str, help='nas search space info')
# NDS-Amoeba ImageNet    Amoeba      nds_amoeba_in
    # Many layers with: ReLU-Conv2d-Conv2d-BN
    # Only two with ReLU-Conv2d-BN
# NDS-DARTS ImageNet     DARTS       nds_darts_in
    # Many layers with: ReLU-Conv2d-Conv2d-BN
    # Only two with ReLU-Conv2d-BN
# NDS-ENAS ImageNet      ENAS        nds_enas_in
    # Many layers with: ReLU-Conv2d-Conv2d-BN
    # Only two with ReLU-Conv2d-BN
# NDS-PNAS ImageNet      PNAS        nds_pnas_in
    # Many layers with: ReLU-Conv2d-Conv2d-BN
    # Only two with ReLU-Conv2d-BN
# NDS-NASNet ImageNet    NASNet      nds_nasnet_in
    # Many layers with: ReLU-Conv2d-Conv2d-BN
    # Only two with ReLU-Conv2d-BN
...
i_reg  = 0
num_nets = network_sampler.__len__()
print(num_nets)
while i_reg  < NUM_NETS:
    rand_num = random.randint(0, num_nets-1)
    state_dict = {}
    ...
    exit(0)
    conv_module_list = [x for x in net.modules() if x.__class__.__name__.__contains__('Sequential')]
    layer_module_list = []
